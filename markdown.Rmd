...
plot(low_tree_masked,col='yellow') #check to see if it works
```
...
It seems easier to convert green area polygons into a raster and then cut the canopy with this rasterized layer of green areas.
